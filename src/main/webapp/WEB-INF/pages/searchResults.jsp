...
<body>
		...
		<div class="row">
			<div class="col-xs-12 text-left spacer">
				<div class="panel panel-default">
					<div class="panel-heading text-transformer"><h4>Searched Results</h4></div>
	...
	<ul class="pager">
		<li class="<c:if test="${previous}">disabled</c:if>"><a
			href="search?query=${query}&offset=${offset-1}">Previous</a></li>
		<li class="<c:if test="${next}">disabled</c:if>"><a
			href="search?query=${query}&offset=${offset+1}">Next</a></li>
	</ul>
