...
<body>
				...
				<div class="row">
					<div class="12u">
						<section class="box style1">
							<span class="icon featured fa fa-rocket"></span>
							<h3>Develop Web Applications</h3>
							<p>Developed various WEB based applications. Primarily a
								backend java developer.Worked on various frameworks such as
								Spring, Hibernate, Spring batch, GWT and JSF. I have deep
								knowledge of and experience with the SOLR search platform and
								Mongo DB. My passion towards technology drives me more and
								explore each of the framework and learn its benefits.</p>
						</section>
					</div>
					<div class="4u 12u(mobile)">
						<section class="box style1">
							<span class="icon featured fa fa-database"></span>
							<h3>My passion towards technologies</h3>
							<p>I have a deep passion on</p>
						</section>
					</div>
					<div class="4u 12u(mobile)">
						<section class="box style1">
							<span class="icon featured fa-thumbs-o-up"></span>
							<h3>Enjoy during my free time</h3>
							<p>I love traveling and have a big checklist which i want to
								visit</p>
						</section>
					</div>
				</div>
	...
	<script
		src="<c:url value="/resources/assets/js/skel-viewport.min.js"/>"></script>
